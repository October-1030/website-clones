...
function errorResponse(error: unknown) {
  if (error instanceof MediaSourceError || error instanceof StudyProviderError || error instanceof VideoSessionStoreError || error instanceof UsageAccountingError) {
