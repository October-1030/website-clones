...
const originalStillImageAnimationPool = ["左拉镜", "右拉镜", "缩放", "向左缩小", "向右缩小"];
...
export const draftTemplates: DraftTemplateDefinition[] = [
  {
    ...
    config: {
      ...
      image: { ratio: "9:16", fit: "cover", top: 0, height: 1, animation: originalStillImageAnimationPool, motionStrength: 1 },
      ...
      caption: { visible: true, x: 0, y: -0.21510416666666668, fontSize: 14, color: "#FFDE00", alpha: 1, bold: false, underline: false, align: 1, letterSpacing: 0, lineSpacing: 0, border: { color: "#000000", width: 0, alpha: 0 }, maxCharsPerLine: 12, background: { color: "#000000", alpha: 0.5, roundRadius: 0.3 } },
      disclaimer: { visible: true, x: 0, y: -0.903125, fontSize: 8, color: "#FFFFFF", alpha: 0.26, bold: false, underline: false, align: 1, letterSpacing: 0, lineSpacing: 5, border: { color: "#000000", width: 40, alpha: 1 }, text: "图片由 AI 生成与网络下载\n科普视频，无不良引导" },
  ...
  },
  {
    ...
    config: {
      canvas: { width: 1080, height: 1920, ratio: "9:16", backgroundColor: "#000000", backgroundImage: "" },
      image: { ratio: "4:3", fit: "cover", top: 0.2890625, height: 0.421875, animation: originalStillImageAnimationPool },
      ...
      disclaimer: { visible: true, x: 0, y: -0.8141628912685337, fontSize: 8, color: "#FFFFFF", alpha: 1, bold: false, underline: false, align: 1, letterSpacing: 0, lineSpacing: 5, border: { color: "#000000", width: 40, alpha: 1 }, text: "图片由 AI 生成与网络下载\n科普视频，无不良引导" },
      audio: { narrationVolume: 10, bgmVolume: 3, bgmFadeOutMs: 2000 },
      frame: { enabled: false, headerColor: "#13245e", headerColorEnd: "", footerColor: "#000000", footerColorEnd: "", imageBorderColor: "#f5c518", imageBorderWidth: 6, imageBorderSides: "all" },
    },
  },
  {
    ...
    config: {
      ...
      image: { ratio: "16:9", fit: "cover", top: 0, height: 1, animation: originalStillImageAnimationPool },
      ...
      disclaimer: { visible: true, x: 0, y: -0.8787037037037037, fontSize: 5, color: "#FFFFFF", alpha: 0.5, bold: false, underline: false, align: 1, letterSpacing: 0, lineSpacing: 5, border: { color: "#000000", width: 40, alpha: 1 }, text: "图片由 AI 生成与网络下载\n科普视频，无不良引导" },
      audio: { narrationVolume: 10, bgmVolume: 3, bgmFadeOutMs: 2000 },
      frame: { enabled: false, headerColor: "#13245e", headerColorEnd: "", footerColor: "#000000", footerColorEnd: "", imageBorderColor: "#f5c518", imageBorderWidth: 6, imageBorderSides: "all" },
    },
  },
  {
    ...
    config: {
      ...
      disclaimer: { visible: false, x: 0, y: -0.92, fontSize: 8, color: "#FFFFFF", alpha: 0.4, bold: false, underline: false, align: 1, letterSpacing: 0, lineSpacing: 5, border: { color: "#000000", width: 40, alpha: 1 }, text: "图片由 AI 生成" },
      audio: { narrationVolume: 10, bgmVolume: 3, bgmFadeOutMs: 2000 },
