...
const pageInfo: Record<SupportPageProps["page"], { title: string; description: string; features: string[] }> = {
  ...
  "draft-templates": { title: "草稿模板", description: "查看原版剪映画布、正文字幕、片头标题、免责声明和音量参数。", features: ["4 套原版模板", "真实参数", "创建任务时套用"] },
